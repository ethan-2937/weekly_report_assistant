...
Codex skill ?? `codex-skills/weekly-report-assistant`??????????? `~/.codex/skills/weekly-report-assistant`?
...
Docker ????? `22080:8088`????? `22080` ??????? Spring Boot `8088`??? `22080` ???????????????
